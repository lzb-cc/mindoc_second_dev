...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $howToCopy = $('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973"  style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>');
        var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
...
_e(function (E, $) {
    E.plugin(function () {
        ...
        var $toolbar = $('<div class="txt-toolbar"></div>');
        var $triangle = $('<div class="tip-triangle"></div>');
        var $triggerLink = $('<a href="#" ><i class="wangeditor-menu-img-link"></i> ' + lang.openLink + '</a>');
        var isRendered;
